...
const AboutMe = () => {
    return(
       <section className='max-w-screen-xl px-6 mx-auto py-10 md:py-24' id='about'>
        <h5 className='text-primary text-2xl md:text-4xl font-semibold text-center md:text-left pb-10 md:pb-14'></h5>
        <div className='grid grid-cols-1 md:grid-cols-3 md:gap-4'>
            <img className='w-full h-80 object-cover rounded-lg mb-4 md:mb-0' src={PROFILE_PIC} alt="" />
            <div className='col-span-2 bg-gradient-to-br from-blue-950 to-slate-00 rounded-lg border border-blue-800/40 p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-5'>
            <InfoCard 
                ...
                lable="Anos de Experiência"
            />
            <InfoCard 
                count={ABOUT_ME_DATA.stats.numberOfProjects}
                lable="Projetos Concluídos"
            />
            <InfoCard 
