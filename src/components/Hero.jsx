    ...
    return(
        ...
        >
            <div className='flex-1 text-center md:text-left z-[1]'>
                <span className='text-xs md:text-sm text-blue-200 font-thin'>Desenvolvedor Fullstack</span>
                <h2 className='text-3xl mt-3 md:text-5xl md:mt-5'>{name}</h2>
                <p className='w-full text-sx font-light text-neutral-50 leading-5 my-6 lg:w-[38vw] md:text-sm md:leading-6 md:my-8'>{tagLine}</p>
                <button className='primary-btn'> Me Contate!</button>
            </div>
            <div className='flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]'>
                <div className='w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-950 p-6'>
                    ...
                    <div className='bg-cardbg rounded-md text-center mt-3 p-4'>
                        ...
                        <p className='text-slate-500 text-sx md:font-medium mt-1'>{jobTitle}</p>

                        <div className='flex items-center justify-center gap-2 text-slate-500 text-sx mt-1'>
                        ...
                        <div className='flex items-center gap-2 flex-wrap my-3'>
                            {skills.map((item) => (
                                <div key={item} className='text-[11px] bg-blue-800/300 rounded md:text-xs px-3 py-1'>
                                    {item}
                                </div>
                            ))}
                        </div>
