...
const Contact = () => {
    return(
        <section className='max-w-screen-xl mx-auto px-6 pb-20' id='contact'>
            <h5 className='text-primary text-2xl md:text-4xl font-semibold text-center pb-8 mb:pb-14'>
                Contato
            </h5>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-16'>
                ...
                <div>
                    <h5 className='md:hidden text-cyan-300 text-lg font-medium mt-4 pb-5'>Formulário para Contato</h5>
